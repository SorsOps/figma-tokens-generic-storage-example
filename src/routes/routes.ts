...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { TokensController } from './../controllers/index';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/:tokenSet',
            ...
            const args = {
                    tokenSet: {"in":"path","name":"tokenSet","required":true,"dataType":"string"},
                    ...
                    version: {"in":"query","name":"version","dataType":"string"},
            };
        ...
        app.put('/:tokenSet',
            ...(fetchMiddlewares<RequestHandler>(TokensController)),
            ...(fetchMiddlewares<RequestHandler>(TokensController.prototype.putTokens)),

            function TokensController_putTokens(request: any, response: any, next: any) {
            const args = {
                    tokenSet: {"in":"path","name":"tokenSet","required":true,"dataType":"string"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"PutRequest"},
                    notFoundResponse: {"in":"res","name":"404","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"reason":{"dataType":"string","required":true}}},
            };
            ...
            try {
              ...
              const promise = controller.putTokens.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/:tokenSet',
            ...(fetchMiddlewares<RequestHandler>(TokensController)),
            ...(fetchMiddlewares<RequestHandler>(TokensController.prototype.postTokens)),

            function TokensController_postTokens(request: any, response: any, next: any) {
            const args = {
                    tokenSet: {"in":"path","name":"tokenSet","required":true,"dataType":"string"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"PostRequest"},
            };
